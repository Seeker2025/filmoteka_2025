import{a as b}from"./vendor-BNzshISR.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const I=document.querySelector(".icon_yellow_js");function w(){setInterval(()=>{I.classList.toggle("icon_scale")},600)}w();const A="/filmoteka_2025/assets/no_img02-C_eq9g-1.png",N="/filmoteka_2025/assets/noth-DYALNzd5.png",S="/filmoteka_2025/assets/mistake404-HNkT3Q-g.png";function h(e){let t=[];return(JSON.parse(localStorage.getItem("genres"))??[]).map(i=>{e.map(r=>{i.id===r&&t.push(i.name)})}),t}document.querySelector(".gallery");document.querySelector("ul.gallery");function M(e,t){if(e==="mistake404"){const s=`
     ...
     <div class="card_box">
            ...
            allowfullscreen>
                ...
                <div class = "modal ${l}">
                        ...
                        <picture class="picture">
                                ${k(T,d).then(({results:u})=>{console.log(u);const f=document.querySelector(".picture");if(!u?.length)f.innerHTML=p;else{let _=u[0].key;$(f,_)}})}
                        </picture>                       
        ...
        ${g||"Unfortunately, this film does not have a description yet."}
                        ...
                        <td>
        <button type="button" class="arange_button ${l}">ADD TO WATCHED</button>
                        </td>
                        <td>
        <button type="button" class="white_button ${l}">ADD TO QUEUE</button>
                        </td>
                                        </tr>
