import{a as _}from"./vendor-D4Zk_CBc.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();const y=document.querySelector(".icon_yellow_js");function b(){setInterval(()=>{y.classList.toggle("icon_scale")},600)}b();const p="/filmoteka_2025/assets/no_img02-C_eq9g-1.png",I="/filmoteka_2025/assets/noth-DYALNzd5.png",N="/filmoteka_2025/assets/mistake404-HNkT3Q-g.png";function f(e){let r=[];return(JSON.parse(localStorage.getItem("genres"))??[]).map(o=>{e.map(s=>{o.id===s&&r.push(o.name)})}),r}document.querySelector(".gallery");document.querySelector("ul.gallery");function k(e,r){if(e==="mistake404"){const t=`
                             ...
                             <img class="img_of_card" src=${N} alt="404">
                                     ...
                                     `;r.innerHTML=t}if(e?.length){const t=e.map(({poster_path:o,id:s,title:a,release_date:i,genre_ids:n},d)=>{let l=`<img class="img_of_card" src="https://image.tmdb.org/t/p/w500${o}" alt="${a}">`;return o||(l=`<img class="img_of_card" src=${p} alt="No image">`),`
...
//# sourceMappingURL=toChangeText-JPbgLij-.js.map
