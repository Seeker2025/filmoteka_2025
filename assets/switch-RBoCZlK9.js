         ...
         <h2 class="card_jenre">${A(d).join(", ")||"No genres"} | ${Number.parseInt(i)||"No date"}</h2>
                ...
                <div class = "modal ${u}">
                        <div class="cross">
                                ...
                                ${w(L,l).then(({results:g})=>{if(console.log(g),!g?.length)return p;g[0].key})}
                <table>
                            <caption>${a}</caption>
                                <tr>
                                        <td class="table_cell">
